        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-6">
              ...
              <span className="font-outfit font-bold text-xl tracking-tight">
                Petrichor<span className="text-blue-500">.</span>
              </span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              ...
              <li><Link to="/consultancy" className="hover:text-blue-500 transition-colors">Free Consultancy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              <li><Link to="/services/web-app" className="hover:text-blue-500 transition-colors">Web & App Dev</Link></li>
              <li><Link to="/services/software-dev" className="hover:text-blue-500 transition-colors">Software Systems</Link></li>
              <li><Link to="/services/ai-ml" className="hover:text-blue-500 transition-colors">AI & Data Science</Link></li>
              <li><Link to="/services/research" className="hover:text-blue-500 transition-colors">R&D Lab</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-400 text-sm">
              ...
              <li className="flex gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-500"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                <span>hello@petrichortech.com</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Silicon Valley, Innovation Way</span>
              </li>
            </ul>
          </div>
        </div>
